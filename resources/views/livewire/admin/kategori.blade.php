<div>
        ...
        <table class="table table-hover">
            <thead>
                <tr>
                    ...
                    <th class="border-gray-200">Nama Kategori</th>
                ...
                <tr>
                    <td>
                        <a href="#" class="fw-bold">
                            {{ ($loop->index) + (($kategoris->currentPage() - 1) * $kategoris->perPage()) + 1 }}
                        </a>
                    </td>
                    <td>
                        <span class="fw-normal">{{ $kategori->nama }}</span>
                    </td>
                    <td>
                        <span class="fw-normal">{{ $kategori->slug }}</span>
                    </td>
                    <td class="text-end">
                        <a href="#" class="btn btn-info btn-sm btn-rounded" wire:click.prevent="edit({{ $kategori->id }})" data-bs-toggle="modal" data-bs-target="#modalEdit">Edit</a>
                        <a href="#" wire:click.prevent="hapus({{ $kategori->id }})" class="btn btn-danger btn-sm btn-rounded">Delete</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
        </table>
        <div class="mt-2">{{ $kategoris->links() }}</div>
    </div>
    ...
    <div wire:ignore.self class="modal fade" id="modalEdit" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content ">
                <div class="modal-header">
                    <h2 class="h6 modal-title">Update Kategori</h2>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form>
                    @csrf
