<div>
    ...
    <div class="card card-body border-0 shadow table-wrapper table-responsive">
                ...
                <tr>
                    <td>
                        <a href="#" class="fw-bold">
                            {{ ($loop->index) + (($kriterias->currentPage() - 1) * $kriterias->perPage()) + 1 }}
                        </a>
                    </td>
                    <td>
                        <span class="fw-normal">{{ $kriteria->nama_kriteria }}</span>
                    </td>
                    <td>
        ...
        <div class="mt-2">{{ $kriterias->links() }}</div>
    </div>
    <!-- Modal Content -->
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content ">
                <div class="modal-header">
                    <h2 class="h6 modal-title">Tambah Kriteria</h2>
                ...
                <form>
                    ...
                    <div class="modal-body">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control @error('nama_kriteria') is-invalid @enderror" wire:model="nama_kriteria">
                            @error('nama_kriteria') <span class="text-danger">{{ $message }}</span> @enderror
                        </div>
                        <div class="form-group mb-3">
                            <label class="form-label">Bobot</label>
                            <input type="number" class="form-control @error('bobot') is-invalid @enderror" wire:model="bobot" placeholder="ex. 0.1">
                            @error('bobot') <span class="text-danger">{{ $message }}</span> @enderror
                        </div>
                        <div class="form-group mb-3">
                            <label class="form-label">Tren</label>
                            <select class="form-select @error('tren') is-invalid @enderror" wire:model="tren">
    ...
    <div wire:ignore.self class="modal fade" id="modaEdit" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content ">
                <div class="modal-header">
                    <h2 class="h6 modal-title">Update Kriteria</h2>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form>
                    @csrf
                    <div class="modal-body">
                        ...
                        <div class="form-group mb-3">
                            <label class="form-label">Bobot</label>
                            <input type="number" class="form-control @error('bobot') is-invalid @enderror" wire:model="bobot" placeholder="ex. 0.25">
                            @error('bobot') <span class="text-danger">{{ $message }}</span> @enderror
                        </div>
                        <div class="form-group mb-3">
                            <label class="form-label">Tren</label>
